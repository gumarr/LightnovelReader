  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'subtitle-past': 'rgb(var(--subtitle-past) / <alpha-value>)',
        'subtitle-current': 'rgb(var(--subtitle-current) / <alpha-value>)',
        'subtitle-future': 'rgb(var(--subtitle-future) / <alpha-value>)',
      },
    },
  },
  plugins: [],
