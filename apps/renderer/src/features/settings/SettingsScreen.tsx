...
export const SettingsScreen = ({ onBack, onManageStorage }: SettingsScreenProps): JSX.Element => {
  ...
  return (
    ...
    */
    <div data-testid="settings-screen-scroll" className="h-full overflow-y-auto">
      <section
